...
**Keep this file up to date when adding or removing containers. Next free IP: `192.168.0.233`**
...
| 192.168.0.210   | 107   | node2 | optmovementpt           |                                                           |
| 192.168.0.211   | 109   | node2 | n8n                     |                                                           |
| 192.168.0.212   | 110   | node1 | gemini-bridge           |                                                           |
...
| —               | 108   | node2 | cloudflare-ddns         | DHCP — no static IP                                       |
